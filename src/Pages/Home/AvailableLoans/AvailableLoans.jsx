...
const AvailableLoans = () => {
    ...
    const displayLoans = combinedLoans.filter(loan => loan.showOnHome);
        ...
        <div className="space-y-10">
            <div>
                ...
                <p className="text-base-content/70">
                    Discover loan options that fit your financial goals
                </p>
            </div>
            <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    {isLoading || loansLoading ? (
                        ...
                        displayLoans.map((loan, index) => (
                            <FadeIn key={loan._id} delay={index * 0.1}>
                                <div className="card bg-base-100 shadow-lg rounded-xl border border-base-300 hover:shadow-xl transition-all duration-300 group">
                                    {/* Loan Image */}
                ...
                {/* Empty State */}
                {!isLoading && !loansLoading && displayLoans.length === 0 && (
